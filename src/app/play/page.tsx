      ...
      <div className='max-w-2xl mx-auto'>
        ...
        <div className='flex gap-4 mb-6'>
          {(['rated', 'casual'] as const).map((type) => (
            <button
              ...
              } ${isInQueue ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''}`}
            >
        ...
        <div className='mt-6 text-center'>
          <button
            ...
            disabled={isInQueue}
            className={`text-slate-400 hover:text-white transition-colors text-sm ${isInQueue ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''}`}
          >
